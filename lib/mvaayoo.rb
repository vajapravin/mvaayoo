...
module Mvaayoo
  ...
  def self.send_message msg, receipient_no
    ...
    http_conn '/mvaayooapi/MessageCompose', ["user=#{MVAAYOO_USER}:#{MVAAYOO_PASSWORD}", "receipientno=#{receipient_no}", "msgtype=4", "senderID=#{SENDER_ID}", "dcs=8", "msgtxt=#{message}", "ishex=1", "state=4", "msgtype=4", "ishex=1"] 
  end
